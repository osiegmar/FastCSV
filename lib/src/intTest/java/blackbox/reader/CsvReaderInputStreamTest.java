...
class CsvReaderInputStreamTest {
    ...
    @Test
    void csvRecordOfInputStream() throws IOException {
    ...
    @Test
    void csvRecordOfInputStreamWEncoding() throws IOException {
    ...
    @Test
    void namedCsvRecordOfInputStream() throws IOException {
    ...
    @Test
    void namedCsvRecordOfInputStreamWEncoding() throws IOException {

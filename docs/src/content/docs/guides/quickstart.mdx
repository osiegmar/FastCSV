...
description: Get started with FastCSV in minutes. Add the Maven/Gradle dependency and write your first CSV reader and writer in Java.
sidebar:
  order: 1
---
...
// build.gradle.kts
dependencies {
    implementation("de.siegmar:fastcsv:${version}")
}
        `.trim()} lang="kotlin" />
    </TabItem>

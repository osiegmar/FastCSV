---
title: Contribution
description: "How to contribute to FastCSV: prerequisites, project setup, code quality requirements, and pull request guidelines."
---
...
2. Create a feature branch from the `develop` branch
    ...
    The `main` branch is reserved for the current released version. Always base your work on the `develop` branch:

...
- Removed class `SimpleFieldModifier` and methods `FieldModifiers#lower(Locale)` and `FieldModifiers#upper(Locale)` in favor of more versatile `FieldModifiers#transform(Function<String, String>)` method
